...
class SeeingInDark(nn.Module):
    def __init__(self, num_classes=10):
        super(SeeingInDark, self).__init__()
    ...
    def forward(self, x):
        ...
        '''print("hI",conv1.shape)'''
        conv1 = self.lrelu(self.conv1_2(conv1))
        pool1 = self.pool1(conv1)
        '''print("hi", pool1.shape)'''
        conv2 = self.lrelu(self.conv2_1(pool1))
        '''print("hELLO", conv2.shape)'''
...
class SeeingInDark_RGB(nn.Module):
    def __init__(self, num_classes=10):
        super(SeeingInDark_RGB, self).__init__()
