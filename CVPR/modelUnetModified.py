...
class Net(nn.Module):
    ...
    def __init__(self):
        ...
        self.conv32x = nn.Sequential(        
                        conv_layer(3072, 1024, kernel_size=3, groups=1024, bias=True, negative_slope=1, bn=False, init_type='kaiming', fan_type='fan_in', activation=False, pixelshuffle_init=False, upscale=False, num_classes=False, weight_normalization = True),
        ...
        self.conv32_8_cat = nn.Sequential(
                        conv_layer(256, 128, kernel_size=3, groups=4, bias=True, negative_slope=1, bn=False, init_type='kaiming', fan_type='fan_in', activation=False, pixelshuffle_init=False, upscale=False, num_classes=False, weight_normalization = True),
        ...
        self.conv2x = nn.Sequential(
                        conv_layer(12, 4, kernel_size=5, groups=1, bias=True, negative_slope=1, bn=False, init_type='kaiming', fan_type='fan_in', activation=False, pixelshuffle_init=False, upscale=False, num_classes=False, weight_normalization = True),
                        conv_layer(4, 12, kernel_size=5, groups=1, bias=True, negative_slope=1, bn=False, init_type='kaiming', fan_type='fan_in', activation=False, pixelshuffle_init=False, upscale=False, num_classes=False, weight_normalization = True))
    ...
    def forward(self,low):
        ...
        #print(cat_32_8.shape)
        cat_32_8 = self.conv32_8_cat(cat_32_8)
        
        #print(cat_32_8.shape)
        #print(self.conv2x(low2x))
        # 2x branch starts
